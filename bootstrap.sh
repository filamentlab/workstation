...
apt-get -y install php5 php5-cli libapache2-mod-php5 php5-curl php5-mcrypt php5-gd php5-mysql php-gettext >> /vagrant/vm_build.log 2>&1

echo -e "\n--- Enabling mod-rewrite ---\n"
/vagrant/files/vhost.sh $IPADDR > /etc/apache2/sites-available/workstation.conf
